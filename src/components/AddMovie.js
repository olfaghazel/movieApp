...
const AddMovie = ({ setMovieTitle, setMoviePosterUrl, setMovieRate, setMovieDescription, setTrailer, setFormDisplay, handleSubmit }) => {
    return (
        < Modal.Dialog className="modalDilalog">
            ...
            <Modal.Body>
                <Form >
                    ...
                    <Form.Control className="formControl" required onChange={(e) => setTrailer(e.target.value)} as="textarea" rows={2} placeholder="URL trailer" />
                </Form>
            </Modal.Body>
